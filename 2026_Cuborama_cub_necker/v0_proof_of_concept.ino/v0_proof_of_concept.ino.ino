...
int pinCount = 9;
byte ledPins[] = {2, 3, 4, 5, 6, 7, 8, 9, 10};
byte blueledPins[] = {2, 3, 5, 6, 8, 9};
byte orangeledPins[] = {4, 7, 10};
int bluepinCount = 6;
int orangepinCount =3;
...
void setup() {
  ...
  display.setBrightness(3); //0 to 3 level of brightness
